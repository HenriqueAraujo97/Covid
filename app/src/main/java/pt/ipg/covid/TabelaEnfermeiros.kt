...
class TabelaEnfermeiros(db: SQLiteDatabase) {
    ...
    fun cria(){
        db.execSQL("CREATE TABLE $NOME_TABELA (${BaseColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT, $NOME_ENFERMEIRO TEXT NOT NULL, $NR_ENFERMEIRO TEXT NOT NULL, FOREIGN KEY ($CAMPO_ID_ENFERMEIRO) REFERENCES ${TabelaPacientes.NOME_TABELA})")
    }
